 ...
 * (C:\\Users\\Jesus\\.aws\\credentials) where the sample code will load the credentials from.
 * <p>
    ...
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            throw new AmazonClientException(
                    ...
                    "location (C:\\Users\\Jesus\\.aws\\credentials), and is in valid format.",
                    e);
        }
        ...
        try {
            ...
            createRequest.setTemplateBody(convertStreamToString(CloudFormationSample.class.getResourceAsStream("CloudFormation.template")));
